...
(
    ...
    STATS_HOME_TOTAL_MATCH INTEGER NOT NULL,
    STATS_HOME_FIRSTTIME_MATCH INTEGER NOT NULL,
    STATS_HOME_SECONDTIME_MATCH INTEGER NOT NULL,
    STATS_AWAY_TOTAL_MATCH INTEGER NOT NULL,
    STATS_AWAY_FIRSTTIME_MATCH INTEGER NOT NULL,
    STATS_AWAY_SECONDTIME_MATCH INTEGER NOT NULL,
