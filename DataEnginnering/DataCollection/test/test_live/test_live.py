import pytest
from properties import queries
...
@pytest.mark.parametrize("website_path",
                         [("file:///C:/Users/Cesar/Documents/Apuestas/ml_corners_predictor/DataEnginnering/DataCollection/test/test_live/test_data/website_today_matches.mhtml")])
...
@pytest.mark.parametrize("website_path",
                         [("file:///C:/Users/Cesar/Documents/Apuestas/ml_corners_predictor/DataEnginnering/DataCollection/test/test_live/test_data/website_live_matches.mhtml")])
